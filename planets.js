...
//   //2.2. console.log the eccentricity of Venus
...
// const sumOfSet =(planetOne,planetTwo, PlantetThree, PlanetFour) => {
//     return parseInt(planetOne) + parseInt (planetTwo)+ parseInt(PlantetThree) +parseInt (PlanetFour)
// }
...
console.log(system.mercury.radiusp)
//6. 6. Find the difference between Jupiter's **momentum** and Pluto's **momentum**. (To get momentum, you'll want the product of **velocity** and **mass**)
let momentum1 = (system.jupiter.velocity)*(system.jupiter.mass)
console.log(momentum1)
let momentum2= (system.pluto.velocity)*(system.pluto.mass)
console.log(momentum2)
